...
Логика: v0.2.1 — это последний стабильный релиз ZMK до обновления Zephyr 4.1 (которое сломало board naming). В этой версии nice_nano_v2 — валидное имя платы, как
  и в прошивке продавца (jorne_left-nice_nano_v2-zmk.uf2). Итоговая прошивка должна быть максимально похожа на заводскую.
